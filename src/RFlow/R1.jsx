...
const levelData = {
  ...
  ta: {
    L1: [
      ...
      {
        allwords: [
          { img: getAssetUrl(s3Assets.moonR1TamImage), text: "Moon" },
          { img: getAssetUrl(s3Assets.roseR1TamImage), text: "Rose" },
          { img: getAssetUrl(s3Assets.muscleR1TamImage), text: "Muscle" },
        ],
        correctWord: "Moon",
        audio: getAssetAudioUrl(s3Assets.moonR1TamAudio),
        flowName: "P40",
      },
      {
        allwords: [
          { img: getAssetUrl(s3Assets.cowR1TamImage), text: "Cow" },
          { img: getAssetUrl(s3Assets.rainR1TamImage), text: "Rain" },
          { img: getAssetUrl(s3Assets.thunderR1TamImage), text: "Thunder" },
        ],
        correctWord: "Cow",
        audio: getAssetAudioUrl(s3Assets.cowR1TamAudio),
        flowName: "P41",
      },
      {
        allwords: [
        ...
        correctWord: "Parrot",
        audio: getAssetAudioUrl(s3Assets.parrotR1TamAudio),
        flowName: "P42",
      },
      {
        allwords: [
          { img: getAssetUrl(s3Assets.penR1TamImage), text: "Pen" },
          { img: getAssetUrl(s3Assets.mosquitoR1TamImage), text: "Mosquito" },
          { img: getAssetUrl(s3Assets.tortoiseR1TamImage), text: "Tortoise" },
        ],
        correctWord: "Pen",
        audio: getAssetAudioUrl(s3Assets.penR1TamAudio),
        flowName: "P43",
      },
      {
        allwords: [
        ...
        correctWord: "Male",
        audio: getAssetAudioUrl(s3Assets.maleR1TamAudio),
        flowName: "P44",
      },
      {
        allwords: [
      ...
      },
      {
        allwords: [
          { img: getAssetUrl(s3Assets.headR1TamImage), text: "Head" },
          { img: getAssetUrl(s3Assets.muscleR1TamImage), text: "Muscle" },
          { img: getAssetUrl(s3Assets.moustacheR1TamImage), text: "Moustache" },
        ],
        correctWord: "Moustache",
        audio: getAssetAudioUrl(s3Assets.moustacheR1TamAudio),
        flowName: "P46",
      },
      {
        allwords: [
          { img: getAssetUrl(s3Assets.jumpR1TamImage), text: "Jump" },
          { img: getAssetUrl(s3Assets.plantR1TamImage), text: "Plant" },
          { img: getAssetUrl(s3Assets.drumR1TamImage), text: "Drum" },
        ],
        correctWord: "Plant",
        audio: getAssetAudioUrl(s3Assets.plantR1TamAudio),
        flowName: "P47",
      },
      {
        allwords: [
